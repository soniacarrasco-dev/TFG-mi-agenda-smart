/* SCRIPT DE BASE DE DATOS: mi_agenda_smart 
   ORDEN DE EJECUCIÓN: 
   1. Usuarios -> 2. Profesores -> 3. Asignaturas -> 4. Eventos 
*/

CREATE DATABASE IF NOT EXISTS `mi_agenda_smart` 
...
-- ------------------------------------------------------
-- 2. ESTRUCTURA Y DATOS: PROFESORES
-- ------------------------------------------------------
...
(5,'Maria Jesus Rodríguez Sanchez','maria@gmail.com','Lunes de 8:00 a 10:00 h',2),
(6,'Alejandro Romero Morales','alejandroromero@cesurformacion.com','Martes de 10:00 a 12:00 h',2),
(23,'Carlos Pastor Paz','carlos@gmail.com','Miercoles de 10:00 a 12:00 h',2),
(24,'Laura Torres Jiménez','',NULL,2),
(25,'Daniel de la Torre Bolos','',NULL,2),
(26,'Paloma Ales Hermosa','',NULL,2),
(36,'María Jesús Rodríguez Sánchez','maria@gmail.com',NULL,3),
(37,'Alejandro Romero Morales','alejandro@gmail.com',NULL,3),
(38,'Carlos Pastor Paz','carlos@gmail.com',NULL,3),
(39,'Laura Torres Jimenez','laura@gmail.com',NULL,3),
(40,'Daniel de la Torre Bolós','daniel@gmail.com',NULL,3),
(41,'Paloma Ales Hermosa','paloma@gmail.com',NULL,3);
UNLOCK TABLES;

-- ------------------------------------------------------
-- 3. ESTRUCTURA Y DATOS: ASIGNATURAS
-- ------------------------------------------------------
...
(10,'DW Entorno Cliente',2,5),(11,'DWE Servidor',2,6),(12,'Despliegue de aplicaciones web',2,23),(13,'Diseño de interfaces web',2,6),(14,'Inglés',2,24),(15,'HLC (Blockchain)',2,25),(16,'Itinerario II',2,26),(21,'prueba',2,NULL),(22,'Dwe Cliente',3,36),(23,'Dwe Servidor',3,37),(24,'Despliegue de aplicaciones web',3,38),(25,'Diseño de interfaces',3,37),(26,'Inglés',3,39),(27,'HLC (Blockchain)',3,40),(28,'Itinerario II',3,41);
UNLOCK TABLES;

-- ------------------------------------------------------
-- 4. ESTRUCTURA Y DATOS: EVENTOS_ACADEMICOS
-- ------------------------------------------------------
